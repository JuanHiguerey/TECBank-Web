...
//cambio a una nueva contrasema
app.post("/api/newpassword/:idUsuario/:password", async (req, res) =>{
    try {
        const ids = await user.Update(req.params.idUsuario, req.params.password)
